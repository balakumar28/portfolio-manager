...
//public class Main {
//
//    private static UserService userService = ServiceFactory.getService(Service.USER);
//    private static ScripService scripService = ServiceFactory.getService(Service.SCRIP);
//    private static ScripHistoryService scripHistoryService = ServiceFactory.getService(Service.SCRIP_HISTORY);
//
